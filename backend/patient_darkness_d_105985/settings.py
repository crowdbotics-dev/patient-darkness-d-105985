"""
Django settings for patient_darkness_d_105985 project.
...
ROOT_URLCONF = 'patient_darkness_d_105985.urls'
...
WSGI_APPLICATION = 'patient_darkness_d_105985.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_darkness_d_105985 API",
    "DESCRIPTION": "API documentation for patient_darkness_d_105985 App",
    "VERSION": "v1",
}
